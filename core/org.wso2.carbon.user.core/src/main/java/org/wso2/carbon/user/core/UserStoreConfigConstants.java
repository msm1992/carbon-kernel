...
public class UserStoreConfigConstants {
    ...
    public static final String immutableAttributesDescription = "User store maintained immutable " +
            "attributes";
    ...
    public static final String timestampAttributesDescription = "Attributes having the data type of Timestamp and " +
            "may require a conversion when reading from/writing to user store";
